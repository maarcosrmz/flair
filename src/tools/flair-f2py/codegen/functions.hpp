...
// `call_args`. Supports intrinsic scalar inputs and wrapped derived-type
// inputs; returns false (procedure skipped) for anything else. Shared with
// method codegen.
