...
str_t gen_method(dtype_info_t const &dt, Fortran::semantics::Symbol const &binding,
...
str_t gen_getset(dtype_info_t const &dt, Fortran::semantics::Symbol const &comp,
